...
import us.twoguys.thedarkness.commands.cmdClasses.BeaconVisionCMD;
import us.twoguys.thedarkness.commands.cmdClasses.CreateBeaconCMD;
import us.twoguys.thedarkness.commands.cmdClasses.GiveCMD;
import us.twoguys.thedarkness.commands.cmdClasses.PasteSchematicCMD;
import us.twoguys.thedarkness.commands.cmdClasses.StatsCMD;
import us.twoguys.thedarkness.commands.cmdClasses.smokeCMD;
...
public class CommandHandler implements CommandExecutor{
	...
	public CommandHandler(TheDarkness instance){
		plugin = instance;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String arg2, String[] args) {
		...
		if(args[0].equalsIgnoreCase("stats")){
			...
			smokeCMD cmd = new smokeCMD(plugin);
			cmd.applySmoke(player, player.getLocation(), Integer.parseInt(args[1]));
		}
		return true;
	}
	...
	private boolean usage(Player player){
		plugin.sendMessage(player, ChatColor.DARK_GRAY+"---------- Commands ----------");
