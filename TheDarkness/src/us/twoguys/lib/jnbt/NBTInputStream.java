...
/*     */     case 8:
/* 139 */       int length1 = this.is.readShort();
/* 140 */       byte[] bytes1 = new byte[length1];
...
/* 145 */       int length11 = this.is.readInt();
/*     */ 
/* 147 */       List tagList = new ArrayList();
/* 148 */       for (int i = 0; i < length11; i++) {
 ...
 * Qualified Name:     org.jnbt.NBTInputStream
